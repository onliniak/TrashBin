 ...
 */
class Drift_KernelDevContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Mercure' => 'getMercureService',
            ...
            'drift.filesystem' => 'getDrift_FilesystemService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/drift/http-kernel/AsyncEventDispatcherInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/drift/http-kernel/AsyncEventDispatcherMethods.php';
            include_once \dirname(__DIR__, 4).'/vendor/drift/http-kernel/AsyncEventDispatcher.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/http-kernel/HttpKernelInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/http-kernel/TerminableInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/http-kernel/HttpKernel.php';
            include_once \dirname(__DIR__, 4).'/vendor/drift/http-kernel/AsyncHttpKernel.php';
     ...
     *
     * @return \Drift\HttpKernel\AsyncEventDispatcher
     */
    protected function getEventDispatcherService()
    {
        $this->services['event_dispatcher'] = $instance = new \Drift\HttpKernel\AsyncEventDispatcher();

        $instance->addListener('kernel.preload', [0 => function () {
            return ($this->privates['Drift\\HttpKernel\\PeriodicTimer\\PeriodicTimer'] ?? ($this->privates['Drift\\HttpKernel\\PeriodicTimer\\PeriodicTimer'] = new \Drift\HttpKernel\PeriodicTimer\PeriodicTimer(($this->services['reactphp.event_loop'] ?? $this->get('reactphp.event_loop', 1)))));
        }, 1 => 'onKernelPreload'], 0);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Drift_KernelDevContainer',
